  ...
  return (
    ...
    >
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        <Image src={NavLogo} alt="logo" width="125" height="80" />
        ...
        <div>
          <ul style={{ color: `${linkColor}` }} className="hidden md:flex">
            ...
            <Link href="/blog">
              <li className="ml-10 text-sm uppercaase hover:border">Blog</li>
            </Link>
            <Link href="/#contact">
        ...
        >
          <div>
            <div className="flex w-full items-center justify-between">
              <Image src={NavLogo} width="87" height="44" alt="/" />
              <div
                onClick={handleNav}
            ...
            <div className="border-b border-gray-33 my-4">
              <p className="w-[85%] md:w=[90%] py-4">Developer Portfolio</p>
            </div>
          </div>
